...
class Config:
    ...
    # "mistral-small-2506",                                    # 3 Mistral   mid general (non-hybrid)
    # "gpt-4.1-mini",                                          # 4 OpenAI    multi-hop QA winner
    # "gpt-5.4-nano",                                          # 5 OpenAI    cheap-mid, new gen
    # ]
    ...
    # # it), so a wrong figure here does not fail loudly -- it just silently
    # # teaches the router the wrong cost ranking.
    # # (0.00000030, 0.00000090), #   Codestral 2508:    DROPPED
    # # (0.00000015, 0.00000060), #   GPT-4o mini:       DROPPED
    # # (0.00000030, 0.00000030), #   Qwen2.5-7B Turbo:  DROPPED
    # (0.00000020, 0.00000125),   # 5 GPT-5.4 nano:      $0.20 / $1.25 per 1M tokens  (confirmed 2026-07-28)
    # ]
    ...
    # SERVICE_RATE = [
    #     # Measured 2026-07-28, n=30 per endpoint, all six in one batch, current
    #     # prompt config (512 cap, TriviaQA/MMLU-Pro/gsm8k mix, MCQ_COT on).
    #     # gpt-4.1-mini read 0.2987 this batch vs 0.4456 the day before -- the
    #     # documented 25-50% batch-to-batch variance, likely provider-hour. Its
    #     # LOW read makes the uniform-policy check marginal (lambda/M = 0.333
    #     # vs mu_mini ~0.30-0.45): under Random/RR the mini queue can grow
    #     # within an episode and drain between them, surfacing as baseline
    #     # latency, not divergence. lambda kept at 2.0 rather than tuned to the
    #     # worst single read of the noisiest entry.
    #     0.8507, # 0 ministral-3b-2512
    #     0.5405, # 1 ministral-8b-2512
    #     0.8049, # 2 gpt-4.1-nano-2025-04-14
    #     0.5691, # 3 mistral-small-2506
    #     0.2987, # 4 gpt-4.1-mini
    #     0.6625, # 5 gpt-5.4-nano
    #    # total 3.726 req/s
    # ]
